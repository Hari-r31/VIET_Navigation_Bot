...
if (!location) {
return ( <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6"> <div className="text-center"> <h1 className="text-xl font-bold text-slate-900 mb-2">
{t?.dir_location_not_found || "Location Not Found"} </h1> <p className="text-slate-500">
{t?.dir_invalid_link || "The requested location could not be found."} </p> </div> </div>
);
}
