...
import { Map, GraduationCap, Sparkles, ChevronRight, Mic } from 'lucide-react';
  ...
  return (
    <div className="flex h-full gap-6 animate-in fade-in duration-500 p-2 relative">
      ...
      <div className="flex-1 flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 h-64">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-blue-100 text-sm font-medium leading-relaxed max-w-xs">{t.card_directions_desc}</p>
            </div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-slate-500 text-sm font-medium leading-relaxed max-w-xs">{t.card_fees_desc}</p>
            </div>
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-8 relative min-h-[280px] gap-4">

          {/* Tap to chat button */}
          <div
            onClick={handleTouchTrigger}
            className="w-32 h-32 bg-white rounded-full shadow-xl flex items-center justify-center cursor-pointer group/banner hover:scale-110 transition-transform duration-300 relative"
          >
          ...
          <div className="text-center max-w-lg">
            <h3 className="text-2xl md:text-3xl font-black text-slate-800 mb-1 tracking-tight">
              Touch to chat
            </h3>
            <p className="text-slate-500 font-medium text-lg mb-4">
              or tap the mic to speak directly
            </p>
            <button
              onClick={handleVoiceTrigger}
              className="px-8 py-3 bg-blue-600 text-white font-bold rounded-full shadow-md hover:bg-blue-700 active:scale-95 transition-all flex items-center gap-2 mx-auto"
            >
        ...
        {isAssistantActive && (
          <Assistant
            ...
            showFab={false}
            defaultOpen={true}
            onClose={() => { setIsAssistantActive(false); setStartVoice(false); }}
